...
ggplot(NFLarrests, aes(y = arrests, x = abs_margin_of_vic, color = margin_of_vic>0)) +
    geom_point(alpha = 0.5)
...
ggplot(OakArrests, aes(y = arrests, x = abs_margin_of_vic)) +
    geom_point() +
    geom_abline(slope = -0.09985, intercept = 18.87948, color = "red")
...
ggplot(PittArrests, aes(y = arrests, x = margin_of_vic)) +
    geom_point() +
    geom_abline(slope = -0.1948, intercept = 18.9663, color = "red")
